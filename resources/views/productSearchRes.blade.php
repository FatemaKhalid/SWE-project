     ...
     <div class="panel panel-default products-panel" id= "Products-panel">
        ...
        <div class="panel-body panel-body-add" id= "body-products" >
         ...
         <ul class="gallery-post-grid holder gallery-add" id= "gallery">
            ...
            @foreach($details as $product_s)

   <li  class="span3 gallery-item " data-id="id-1" data-type="illustration" >
                                                
                           
                                
                          <img  src="assets/images/template_products/gallery/Newest-Travel-Gadgets-Avoid.jpg" alt="Gallery" onclick="aOfimgOnclick()">
                        
                        <span class="project-details">{{$product_s->name}}</span>
                        <span class="project-details">{{$product_s->price}}</span>
            ...
            <script>
            function aOfimgOnclick(){
               this.id = {{$product_s->id}};
