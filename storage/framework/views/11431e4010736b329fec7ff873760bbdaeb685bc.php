...
.parent {
	...
	<script src="<?php echo asset('js/onepage.js'); ?>"></script>
	<script>
...
<script>
setTimeout(function () {
$('#container').load("<?php echo e(Route('yarab')); ?>");
...
function advices(){
             ...
             //htt3`yer hnro7 lsaf7a advices
			   window.open("<?php echo e(URL::route('articles', array('count_name' => 'advices'))); ?>","_parent");
			   
			    //window.location.href="page2.php?name="+a.id;
            }
</script>
	<div id="container">
		<img class="logo" src="<?php echo asset('/assets/images/logo.png'); ?>">
		<div class="circ one"></div>
	</div>

        </div>
    <div class="op-section second"><img id="myImg" src="<?php echo asset('/assets/images/travel-book.jpg'); ?>" height="100%"
    ...
    <div class="op-section fourth">
      ...
      <img class="box1" src="<?php echo asset('/assets/images/art1.jpg'); ?>" >
