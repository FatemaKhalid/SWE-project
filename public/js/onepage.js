...
function startOnePage(myInput){
	...
	*/
	...
	function animateScr(moveTo, duration, distance){
		...
		if(num==0)
		{
			document.getElementById("t").textContent="مقالات";
		}
		else if(num==1)
		{
			document.getElementById("t").textContent="نصائح سفر";
		}
		else if(num==2)
		{
			document.getElementById("t").textContent="منتجات";
		}
		else
		{
			document.getElementById("t").textContent="نبذة عنا";
		}
